...
tumor.epi <- readRDS("/gpfs/gibbs/project/mu/qx75/Grey/choushi/tumor.epi_top1000_p20_res0.1.rds")
colors <- c("0"='#84a59d', "1"='#f28482', "2"="#f6bd60", "3"="#B07AA1")

pdf("/gpfs/gibbs/project/mu/qx75/Grey/choushi/figs/UMAP_tumor_only.pdf", width=5, height=4)
DimPlot(tumor.epi, label = F, raster = F, cols = colors)
dev.off()

pdf("/gpfs/gibbs/project/mu/qx75/Grey/choushi/figs/dotplot_NLN.pdf", width=3.5, height=3.5)
...
saveRDS(tumor.epi, "/gpfs/gibbs/project/mu/qx75/Grey/choushi/tumor.epi_NLN_class(240511).rds")




#-----------------------
tumor.epi <- readRDS("/gpfs/gibbs/project/mu/qx75/Grey/choushi/tumor.epi_NLN_class(240511).rds")
...
VlnPlot(object = tumor.epi, features = "HALLMARK_APOPTOSIS1", pt.size= 0, cols = c("NLN_low"="#D6606B", "NLN_high"="#4575b4"))+
